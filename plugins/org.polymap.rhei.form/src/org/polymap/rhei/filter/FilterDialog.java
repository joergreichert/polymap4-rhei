...
////        }
////        catch (Exception e) {
////            PolymapWorkbench.handleError( RheiFormPlugin.PLUGIN_ID, null, "Fehler beim Suchen und Öffnen der Ergebnisliste.", e );
...
////                    RheiFormPlugin.getDefault().getBundle().getResource( "icons/eview16/newsearch_wiz.gif" ) ).createImage();
////        }
