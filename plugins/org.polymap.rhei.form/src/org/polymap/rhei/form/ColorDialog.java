...
/**
 * Copied and adapted from link org.eclipse.swt.widgets.ColorDialog,
 * to support setting color selection enabled or disabled.
 * 
 * 
...
public class ColorDialog
    ...
    private void createColorArea() {
        ...
        createNoIconButton(displayComp);
    ...
    private void createNoIconButton(Composite composite) {
        noIcon = new Button( shell, SWT.CHECK );
        noIcon.setText( "Use no color" );
        noIcon.setSelection( rgb == null );
